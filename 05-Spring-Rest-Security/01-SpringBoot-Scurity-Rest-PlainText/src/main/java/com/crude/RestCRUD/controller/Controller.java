...
import com.crude.RestCRUD.service.EmployeeServiceImplementation;
...
public class Controller {
    ...
    @Autowired
    public Controller(ObjectMapper theObjectMapper, EmployeeServiceImplementation employeeServiceImplementation)
    {
    ...
    Controller(EmployeeServiceImplementation theService)
    {
      service = theService;
    }
